...
export const networkIconMap: Record<string, string> = {
  ...
  'Gnosis': 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://gnosischain.com&size=128',
  'XRP': 'https://cryptologos.cc/logos/xrp-xrp-logo.svg',
  'Stellar': 'https://cryptologos.cc/logos/stellar-xlm-logo.svg',
  'KCC': 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://kcc.io&size=128',
